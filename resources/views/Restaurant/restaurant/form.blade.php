...
</div><div class="form-group {{ $errors->has('ranking') ? 'has-error' : ''}}">
    {!! Form::label('ranking', 'Ranking', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::number('ranking', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
</div><div class="form-group {{ $errors->has('focalperson') ? 'has-error' : ''}}">
    {!! Form::label('focalperson', 'Focalperson', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('focalperson', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
