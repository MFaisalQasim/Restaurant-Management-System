...
</div><div class="form-group {{ $errors->has('sum') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('date_of_order') ? 'has-error' : ''}}">
    {!! Form::label('date_of_order', 'Date Of Order', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::date('date_of_order', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
        {!! $errors->first('date_of_order', '<p class="help-block">:message</p>') !!}
    </div>
</div><div class="form-group {{ $errors->has('date_of_delivery') ? 'has-error' : ''}}">
    {!! Form::label('date_of_delivery', 'Date Of Delivery', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::date('date_of_delivery', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
